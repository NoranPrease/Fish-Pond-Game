...
public class PublicTests {
	...
	public void testFishEatPlant() {
		...
		Fish f3 = new Fish(3,3,100,Fish.UP);
		Plant p3 = new Plant(2,3,74);
		f3.move();
		Model.fishEatPlant(f3, p3);
		assertTrue(p3.getSize()==0);
	}
	@Test
	public void testAddFish(){
		Model m = new Model(30,30,0,0,0);
		m.addFish(new Fish(2,1,10,Fish.UP));
		m.addFish(new Fish(2,3,10,Fish.DOWN));
		m.moveFish();
		m.moveFish();
		assertTrue(m.getFish().size()==2);
	}
}
